  ...
  return (
    <section id="resturantSection">
      ...
      <div id="menuScroll" className="mt-6 px-4">
        <h1 className="font-black px-2 py-4">Categories</h1>
        <div className="flex flex-row gap-3 overflow-y-auto">
          <a className="text-sm font-bold bg-primary border shadow text-smokyBlack px-2 py-1 rounded-xl">Burger</a>
          <a className="text-sm font-bold bg-whiteColor  border-2 shadow  text-smokyBlack px-2 py-1 rounded-xl">
            Pizza
          </a>
          <a className="text-sm font-bold bg-whiteColor border-2 shadow  text-smokyBlack px-2 py-1 rounded-xl">Salad</a>
          <a className="text-sm font-bold bg-whiteColor border-2 shadow  text-smokyBlack px-2 py-1 rounded-xl">Dummy</a>
          <a className="text-sm font-bold bg-whiteColor border-2 shadow  text-smokyBlack px-2 py-1 rounded-xl">Dummy</a>
          <a className="text-sm font-bold bg-whiteColor border-2 shadow  text-smokyBlack px-2 py-1 rounded-xl">Dummy</a>
          <a className="text-sm font-bold bg-whiteColor border-2 shadow   text-smokyBlack px-2 py-1 rounded-xl">
            Dummy
      ...
      <div>
        <h1 className="px-6 py-4 font-black">Popular</h1>
